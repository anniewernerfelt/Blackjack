...
public class Blackjack extends Applet implements Runnable, MouseMotionListener, MouseListener
{
   public int xTitle;
   public int yTitle;
   ...
   public Image hitPic;
   public Image stayPic;
   public Image restartPic;
   public Image cardPic;
   public MyButton hitbutton;
   public MyButton staybutton;
   ...
   public void init()
   {
      ...
      //button
      hitPic = getImage(getDocumentBase(),"hitbutton.jpg");
      stayPic = getImage(getDocumentBase(),"staybutton.jpg");
      restartPic = getImage(getDocumentBase(), "restartbutton.jpg");
      cardPic = getImage(getDocumentBase(), "cards.jpg");
       
      hitbutton = new MyButton( 100, 460, 152, 54, "hit");
      staybutton = new MyButton (350, 460, 152, 54, "stay");
      restartbutton = new MyButton (600, 460, 152, 54, "restart");
...
//*****MouseListener Methods*****************************************************
   ...
   public void mouseClicked(MouseEvent e) {
      ...
      if(hitbutton.rec.contains(mouseX, mouseY))
      {
      ...
      if(staybutton.rec.contains(mouseX, mouseY))
      {
      ...
      if(restartbutton.rec.contains(mouseX, mouseY))
      {
